...
class Wcwm_Import_Content {
	...
	public static function execute( $params ) {
		...
		// Set progress
		Wcwm_Status::info( sprintf( __( 'Restoring %d files...<br />%d%% complete', WCWM_PLUGIN_NAME ), $total_files_count, $progress ) );
		...
		foreach ( $blogs as $blog ) {
			if ( wcwm_main_site( $blog['Old']['BlogID'] ) === false ) {
				if ( defined( 'UPLOADBLOGSDIR' ) ) {
					// Old sites dir style
					$old_paths[] = wcwm_files_path( $blog['Old']['BlogID'] );
					$new_paths[] = wcwm_files_path( $blog['New']['BlogID'] );

					// New sites dir style
					$old_paths[] = wcwm_sites_path( $blog['Old']['BlogID'] );
					$new_paths[] = wcwm_files_path( $blog['New']['BlogID'] );
				} else {
					// Old sites dir style
					$old_paths[] = wcwm_files_path( $blog['Old']['BlogID'] );
					$new_paths[] = wcwm_sites_path( $blog['New']['BlogID'] );
