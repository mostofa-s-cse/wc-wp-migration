...
class Wcwm_Export_Content {
	...
	public static function execute( $params ) {
		...
		// Set progress
		Wcwm_Status::info( sprintf( __( 'Archiving %d files...<br />%d%% complete', WCWM_PLUGIN_NAME ), $total_files_count, $progress ) );
		...
		// Get map file
		$filemap = wcwm_open( wcwm_filemap_path( $params ), 'r' );
