...
class Wcwm_Export_Database_File {
	...
	public static function execute( $params ) {
		...
		if ( isset( $params['total_database_size'] ) ) {
			...
			$total_database_size = wcwm_database_bytes( $params );
		}
		...
		// Set progress
		Wcwm_Status::info( sprintf( __( 'Archiving database...<br />%d%% complete', WCWM_PLUGIN_NAME ), $progress ) );
		...
		if ( $archive->add_file( wcwm_database_path( $params ), WCWM_DATABASE_NAME, $database_bytes_written, $database_bytes_offset ) ) {

			// Set progress
			Wcwm_Status::info( __( 'Done archiving database.', WCWM_PLUGIN_NAME ) );
